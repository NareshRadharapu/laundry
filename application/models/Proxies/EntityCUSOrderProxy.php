 ...
 */
class EntityCUSOrderProxy extends \Entity\CUSOrder implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'order_id', 'message', 'status', 'emp_id', 'cue_id', 'cu_id', 'store_id', 'cuOrderDetails', 'updated_at', 'created_at');
    }
}