...
colorAdminApp.controller('CityController',['$rootScope','$scope','$http','pagination',function($rootScope,$scope,$http,$pagination){
	$scope.curPage = 0;
	$scope.pageSize = 5;
	$scope.pagination =0;
	...
	$scope.addCity =  function(){
		console.log('city form submited');
		$http.post('http://192.168.0.102/laundry/admin/cities/store',$scope.city).success(function(response,status){
			$scope.getCities();
			$scope.city ={};
			$scope.city.apply;
	...
	$scope.editCity = function($c){
		...
		$http.post('http://192.168.0.102/laundry/admin/cities/edit',$c).success(function(response,status){
	...
	$scope.statusCity = function($c){
		...
		$http.post('http://192.168.0.102/laundry/admin/cities/status',$c).success(function(response,status){
			console.log(response);
			$scope.getCities();
			}).error(function(error){
				console.log(error);
	...
	$scope.getCities  = function(){
		$http.get('http://192.168.0.102/laundry/admin/cities/lists').success(function(response,status){
			 $scope.cities = response;
			 console.log(response);
			 
			 $scope.cities.apply;
			 $scope.pagination = $pagination.getPages($scope.cities, $scope.pageSize);
			 $scope.pagination.apply;
...
colorAdminApp.controller('AreaController',['$scope','$http','pagination',function($scope,$http,$pagination){
	...
	$scope.cities =[];
	 $http.get('http://192.168.0.102/laundry/admin/cities/lists').success(function(response,status){
		...
		$http.post('http://192.168.0.102/laundry/admin/areas/store',$scope.area).success(function(response,status){
			$scope.area = {name:'',city:''};
			$scope.area.apply;
			$scope.getAreas();
			$scope.area ={};
	...
	$scope.editArea = function($a){
		...
		$http.post('http://192.168.0.102/laundry/admin/areas/edit',$a).success(function(response,status){
	...
	$scope.statusArea = function($a){
		$http.post('http://192.168.0.102/laundry/admin/areas/status',$a).success(function(response,status){
			$scope.getAreas();
			}).error(function(error){
				console.log(error);
			});
	...
	$scope.getAreas  = function(){
		$http.get('http://192.168.0.102/laundry/admin/areas/lists').success(function(response,status){
			 $scope.areas = response;
			 console.log(response);
			 $scope.areas.apply;
			 
			 $scope.pagination = $pagination.getPages($scope.areas, $scope.pageSize);
			 $scope.pagination.apply;
...
colorAdminApp.controller('CatalogController',['$scope','$http','pagination',function($scope,$http,$pagination){
	...
	$scope.addCatalog =  function(){
		...
		$http.post('http://192.168.0.102/laundry/admin/catalog/store',$scope.catalog).success(function(response,status){
			$scope.getCatalogs();
			$scope.catalog ={};
			$scope.catalog.apply;
			}).error(function(error){
	...
	$scope.editCatalog = function($c){
		...
		$http.post('http://192.168.0.102/laundry/admin/catalog/edit',$c).success(function(response,status){
	...
	$scope.statusCatalog = function($c){
		...
		$http.post('http://192.168.0.102/laundry/admin/catalog/status',$c).success(function(response,status){
			console.log(response);
			$scope.getCatalogs();
			}).error(function(error){
				console.log(error);
	...
	$scope.getCatalogs  = function(){
		$http.get('http://192.168.0.102/laundry/admin/catalog/lists').success(function(response,status){
			 $scope.catalogs = response;
			 console.log(response);
			 $scope.catalogs.apply;
			 $scope.pagination = $pagination.getPages($scope.catalogs, $scope.pageSize);
			 $scope.pagination.apply;
...
colorAdminApp.controller('CatalogItemController',['$scope','$http','ls','pagination',function($scope,$http,$ls,$pagination){
	...
	$scope.getServiceItems = function(){
		if($scope.catalogitem.itemtype===undefined)
			return;
			$catalog = $scope.catalogitem;
			$scope.items =  $ls.getServiceItems($catalog).then(function(data){
	...
	$scope.addCatalogItem =  function(){
		...
		$http.post('http://192.168.0.102/laundry/admin/catalog/storeitems',$scope.catalogitem).success(function(response,status){
	...
	$scope.editCatalogItem = function($c){
		...
		$http.post('http://192.168.0.102/laundry/admin/catalog/edititem',$c).success(function(response,status){
	...
	$scope.statusCatalogItem = function($c){
		...
		$http.post('http://192.168.0.102/laundry/admin/catalog/statusitem',$c).success(function(response,status){
			console.log(response);
			$scope.getCatalogs();
			}).error(function(error){
				console.log(error);
	...
	$scope.getCatalogItems = function(){
		 $ls.getCatalogItems().then(function(data){
			...
			$scope.pagination = $pagination.getPages($scope.catalogitems, $scope.pageSize);
 			$scope.pagination.apply;
...
colorAdminApp.controller('ApartmentController',['$scope','$http','pagination',function($scope,$http,$pagination){
	...
	$scope.addApartment =  function(){
		...
		$http.post('http://192.168.0.102/laundry/admin/apartments/store',$scope.apartment).success(function(response,status){
			$scope.getApartments();
			$scope.apartment ={};
	...
	$scope.editApartment = function($a){
		...
		$http.post('http://192.168.0.102/laundry/admin/apartments/edit',$a).success(function(response,status){
	...
	$scope.getApartments  = function(){
		$http.get('http://192.168.0.102/laundry/admin/apartments/lists').success(function(response,status){
			 $scope.apartments = response;
			 console.log(response);
			 $scope.apartments.apply;
			 $scope.pagination = $pagination.getPages($scope.apartments, $scope.pageSize);
			 $scope.pagination.apply;
...
colorAdminApp.controller('BlockController',['$scope','$http','pagination',function($scope,$http,$pagination){
	...
	$scope.addBlock =  function(){
		...
		$http.post('http://192.168.0.102/laundry/admin/blocks/store',$scope.block).success(function(response,status){
			$scope.getBlocks();
			$scope.block ={};
			$scope.block.apply;
			console.log(status);
	...
	$scope.editBlock = function($a){
		$http.put('http://192.168.0.102/laundry/admin/blocks/edit',$a).success(function(response,status){
			$scope.block.name = response.name; // area name populate
	...
	$scope.statusBlock = function($a){
		$http.post('http://192.168.0.102/laundry/admin/blocks/status',$a).success(function(response,status){
			$scope.getBlocks();
			}).error(function(error){
				console.log(error);
			});
	...
	$scope.getBlocks  = function(){
		$http.get('http://192.168.0.102/laundry/admin/blocks/lists').success(function(response,status){
			 $scope.blocks = response;
			 console.log(response);
			 $scope.blocks.apply;
			 
			 $scope.pagination = $pagination.getPages($scope.blocks, $scope.pageSize);
			 $scope.pagination.apply;
...
colorAdminApp.controller('FlatController',['$scope','$http','pagination',function($scope,$http,$pagination){
	...
	$scope.addFlat =  function(){
		...
		$http.post('http://192.168.0.102/laundry/admin/flats/store',$scope.flat).success(function(response,status){
			$scope.getFlats();
			$scope.flat ={};
			$scope.flat.apply;
	...
	$http.get('http://192.168.0.102/laundry/admin/apartments/arealists').success(function(response,status){
		  $scope.apartments = response;
			 $scope.apartments.apply;
			}).error(function(error){
				console.log(error);
	...
	$scope.getBlocks = function(){
		...
		$http.put('http://192.168.0.102/laundry/admin/blocks/lists',$id).success(function(response,status){
		  $scope.blocks = response;
			 $scope.blocks.apply;
			}).error(function(error){
				console.log(error);
	...
	$scope.editFlat = function($f){
		console.log('edit');
		$http.put('http://192.168.0.102/laundry/admin/flats/edit',$f).success(function(response,status){
	...
	$scope.statusFlat = function($a){
		$http.post('http://192.168.0.102/laundry/admin/flats/status',$a).success(function(response,status){
			$scope.getFlats();
			}).error(function(error){
				console.log(error);
			});
	...
	$scope.getFlats  = function(){
		$http.get('http://192.168.0.102/laundry/admin/flats/lists').success(function(response,status){
			 $scope.flats = response;
			 $scope.flats.apply;
			 $scope.pagination = $pagination.getPages($scope.flats,$scope.pageSize);
			 $scope.pagination.apply;
			}).error(function(error){
				console.log(error);
			});
...
colorAdminApp.controller('ItemTypeController',['$scope','$http','pagination',function($scope,$http,$pagination){
	
	$scope.curPage = 0;
	$scope.pageSize = 5;
	$scope.pagination =0;
	$scope.heading = 'Add Itemtype ';
	$scope.itemtype = {name:'',id:''};
	$scope.addItemtype =  function(){
		console.log('itemtype form submited');
		$http.post('http://192.168.0.102/laundry/admin/itemtypes/store',$scope.itemtype).success(function(response,status){
			$scope.getItemtypes();
			$scope.itemtype ={};
	...
	$scope.editItemtype = function($c){
		...
		$http.post('http://192.168.0.102/laundry/admin/itemtypes/edit',$c).success(function(response,status){
	...
	$scope.statusItemtype = function($c){
		console.log('itemtype status');
		$http.post('http://192.168.0.102/laundry/admin/itemtypes/status',$c).success(function(response,status){
			console.log(response);
			$scope.getItemtypes();
			}).error(function(error){
				console.log(error);
	...
	$scope.getItemtypes  = function(){
		$http.get('http://192.168.0.102/laundry/admin/itemtypes/lists').success(function(response,status){
			 $scope.itemtypes = response;
			 console.log(response);
			 $scope.itemtypes.apply;
			 $scope.pagination = $pagination.getPages($scope.itemtypes, $scope.pageSize);
 			 $scope.pagination.apply;
...
colorAdminApp.controller('ItemController',['$scope','$http','pagination','FileUploader',function($scope,$http,$pagination,FileUploader){
	$scope.curPage = 0;
	$scope.pageSize = 5;
	$scope.pagination =0;
	
	$scope.heading = 'Add Item ';
	$scope.item = {name:'',id:'',image:''};

	 var uploader = $scope.uploader = new FileUploader({
            url: 'http://192.168.0.102/laundry/admin/items/upload/',
...
//	console.info('uploader', uploader);		
	$scope.addItem =  function(){
		...
		$http.post('http://192.168.0.102/laundry/admin/items/store',$scope.item).success(function(response,status){
			$scope.item.apply;
			$scope.getItems();
			$scope.item ={};
			$scope.item.apply;
	...
	$scope.editItem = function($c){
		...
		$http.post('http://192.168.0.102/laundry/admin/items/edit',$c).success(function(response,status){
	...
	$scope.statusItem = function($c){
		...
		$http.post('http://192.168.0.102/laundry/admin/items/status',$c).success(function(response,status){
			console.log(response);
			$scope.getItems();
			}).error(function(error){
				console.log(error);
	...
	$scope.getItems  = function(){
		$http.get('http://192.168.0.102/laundry/admin/items/lists').success(function(response,status){
			 $scope.items = response;

			 $scope.items.apply;
			 $scope.pagination = $pagination.getPages($scope.items, $scope.pageSize);
			 $scope.pagination.apply;
			}).error(function(error){
				console.log(error);
			});
...
colorAdminApp.controller('ServiceController',['$scope','$http','pagination','FileUploader',function($scope,$http,$pagination,FileUploader){
	$scope.curPage = 0;
	$scope.pageSize = 5;
	$scope.pagination =0;
	
	$scope.heading = 'Add Service ';
	$scope.service = {name:'',id:'',image:'',description:'',discount:''};

	 var uploader = $scope.uploader = new FileUploader({
            url: 'http://192.168.0.102/laundry/admin/services/upload/',
			data: $scope.item.name
        });
...
//	console.info('uploader', uploader);		
	$scope.addService =  function(){
		console.log($scope.item);
		$http.post('http://192.168.0.102/laundry/admin/items/store',$scope.service).success(function(response,status){
			$scope.service.apply;
			$scope.getServices();
			$scope.service ={};
			$scope.service.apply;
	...
	$scope.editService = function($c){
		...
		$http.post('http://192.168.0.102/laundry/admin/services/edit',$c).success(function(response,status){
			
			$scope.service.name = response.name; // item name populate
			$scope.service.id = response.id;
			$scope.description.id = response.description;
	...
	$scope.statusService = function($c){
		...
		$http.post('http://192.168.0.102/laundry/admin/services/status',$c).success(function(response,status){
			console.log(response);
			$scope.getServices();
			}).error(function(error){
				console.log(error);
	...
	$scope.getServices  = function(){
		$http.get('http://192.168.0.102/laundry/admin/services/lists').success(function(response,status){
			 $scope.services = response;
			 $scope.services.apply;
			 
			 $scope.pagination = $pagination.getPages($scope.services, $scope.pageSize);
			 $scope.pagination.apply;
			}).error(function(error){
				console.log(error);
			});
...
colorAdminApp.controller('AddonController',['$scope','$http','pagination','FileUploader',function($scope,$http,$pagination,FileUploader){
	$scope.curPage = 0;
	$scope.pageSize = 5;
	$scope.pagination =0;
	...
	$scope.addon = {name:'',id:'',image:'',price:'', description:''};
	 ...
	 var uploader = $scope.uploader = new FileUploader({
            url: 'http://192.168.0.102/laundry/admin/addon/upload/',
	...
	$scope.addAddon =  function(){
		...
		$http.post('http://192.168.0.102/laundry/admin/addon/store',$scope.addon).success(function(response,status){
			$scope.addon.apply;
			$scope.getAddons();
			$scope.addon ={};
			$scope.addon.apply;
	...
	$scope.editAddon = function($c){
		console.log('item edited');
		$http.post('http://192.168.0.102/laundry/admin/addon/edit',$c).success(function(response,status){
			$scope.addon.name = response.name; // item name populate
	...
	$scope.getAddons  = function(){
		$http.get('http://192.168.0.102/laundry/admin/addon/lists').success(function(response,status){
			 $scope.addons = response;
			 $scope.addons.apply;
			 $scope.pagination = $pagination.getPages($scope.addons, $scope.pageSize);
			 $scope.pagination.apply;
			}).error(function(error){
				console.log(error);
			});
